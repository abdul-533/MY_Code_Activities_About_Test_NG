...
//        String[] userler = {"Ali", "Ismet", "Hakan", "Orxan"};
//
//        for (String u : userler)
//            userTest(u);

    }

    //void userTest(String username) {
    //        System.out.println(username + " Test edildi");
//}
...
// DataProvider olarak kullanılcak metodun tipi Object olmak zorunda.
    public Object[] datalarim() {
        ...
        Object[] userler = {"Ali", "Ismet", "Hakan", "Orxan"};
